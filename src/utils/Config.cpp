...
namespace DeltaVins
{
    ...
    void Config::loadConfigFile(const std::string& datasetDir,const std::string&outputName)
    {
        _clear();
        ...
        {
            throw std::runtime_error("Imu Sample Speed or Image Sample Speed Error, or Imu Sample Speed is not a multiple of Image Sample Speed.");
        }
