...
void fast_corner_detect_10_mask(const fast_byte* img, const fast_byte* mask, int imgWidth, int imgHeight, int widthStep, short barrier, vector<fast_xy>& corners);
