...
using MatrixMf =
    Eigen::Matrix<float, MAX_MATRIX_SIZE, MAX_MATRIX_SIZE, EigenMajorType>;
using MatrixMfR =
    Eigen::Matrix<float, MAX_MATRIX_SIZE, MAX_MATRIX_SIZE, Eigen::RowMajor>;
...
using MatrixOfR =
    Eigen::Matrix<float, MAX_OBS_SIZE, MAX_MATRIX_SIZE + 1, Eigen::RowMajor>;
